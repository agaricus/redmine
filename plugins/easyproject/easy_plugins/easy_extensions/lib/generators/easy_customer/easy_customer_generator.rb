class EasyCustomerGenerator < Rails::Generators::NamedBase
  ...
  def initialize(*args)
    super
    @plugin_name_underscored = "modification_#{file_name.underscore}"
  ...
  def copy_templates
    ...
    template 'stylesheets.css', "#{plugin_path}/assets/stylesheets/#{plugin_name_underscored}.css"
